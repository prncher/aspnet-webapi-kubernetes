...
```bash
 ...
 docker run -it --rm -p 4000:8080 --name webapiapp-container webapiapp (webapiapp-container is the container name)
```
...
|webapiapp-app-deployment    |  NodePort   |   10.99.204.149  |    <none>   |    30080:32653/TCP |   9s       |
